...
--
-- Name: properties fk_properteis_elements; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_properteis_elements FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
